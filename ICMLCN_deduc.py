...
deduc_predicates = ['LivesIn', 'WorksAs', 'OwnsVehicle', 'Practices', 'IsParentOf', 'Attends', 'Eats', 'IsFriendOf', 'IsMarriedTo', 'Speaks', 'Drives', 'Likes', 'IsSiblingOf', 'HasPet', 'Studies']
deduc_entities = ['John', 'Emma', 'Michael', 'Sophia', 'David', 'Olivia', 'Engineer', 'Doctor', 'Teacher', 'NewYork', 'London', 'Paris', 'Guitar', 'Piano', 'Chess', 'Harvard', 'Cambridge', 'Oxford', 'Pizza', 'Sushi', 'Car', 'Bicycle', 'Train', 'English', 'French', 'Spanish', 'Maria', 'Robert', 'Daniel', 'Laura', 'Hiking', 'Cooking', 'Photography', 'Cat', 'Dog', 'Italian', 'Chef', 'German', 'Berlin', 'Soccer']
...
def get_tokens(story_id, permn, last_tokens, var_len, enum, thereex, fols):
    file_path = f"dimac_cnfs_deduc_res\\output_{story_id}_{permn}.txt"
...
def move_txt():
    ...
    source_dir = "dimac_cnfs_deduc"
    destination_dir = "dimac_cnfs_deduc_res"
